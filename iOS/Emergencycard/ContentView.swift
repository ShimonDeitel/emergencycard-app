...
struct ContentView: View {
    ...
    @State private var editingItem: EmergencycardItem?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Family Emergency Card")
            .toolbar {
...
struct AddEditView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(item == nil ? "Add Card" : "Edit Card")
            .toolbar {
